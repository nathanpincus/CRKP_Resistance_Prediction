...
with open("ST258_Imi_Curated_RF_f1Tuned_Xtrain_split{0}.pkl".format(str(args.split)), "rb") as f:
    Xtrain = pickle.load(f)
print(Xtrain.head(), flush=True)
with open("ST258_Imi_Curated_RF_f1Tuned_ytrain_split{0}.pkl".format(str(args.split)), "rb") as f:
    ytrain = pickle.load(f)
print(ytrain.head(), flush=True)

print("Test set:", flush=True)
with open("ST258_Imi_Curated_RF_f1Tuned_Xtest_split{0}.pkl".format(str(args.split)), "rb") as f:
    Xtest = pickle.load(f)
print(Xtrain.head(), flush=True)
with open("ST258_Imi_Curated_RF_f1Tuned_ytest_split{0}.pkl".format(str(args.split)), "rb") as f:
    ytest = pickle.load(f)
...
with open('ST258_Imi_Curated_RF_f1Tuned_split{0}_GridSearch.pkl'.format(str(args.split)), 'wb') as f:
...
Scores.to_csv("ST258_Imi_Curated_RF_f1Tuned_split{0}_CVResults.csv".format(str(args.split)), index=False)
