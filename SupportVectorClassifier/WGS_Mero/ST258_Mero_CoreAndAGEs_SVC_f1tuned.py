# # Using SVC to predict AMR based on Core and Accessory Genomes
...
# Pickle final model
with open('ST258_Mero_CoreAndAGEs_SVC_f1Tuned_GridSearch.pkl', 'wb') as f:
    pickle.dump(GSCV_CG_AG, f)

# Plot learning curve
GSCV_CG_AG = GridSearchCV(pipe_CG_AG, param_grid, scoring="f1", cv=stratkf, iid=False, n_jobs=-1)

file_lc = "ST258_Mero_CoreAndAGEs_SVC_f1Tuned_LearningCurve_95CI.pdf"
